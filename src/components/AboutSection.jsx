      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Beyond just writing code, I care about the why behind the product—understanding user needs, aligning with business goals,
              and delivering features that matter. I’m experienced across the entire development lifecycle, from planning and architecture to deployment and maintenance.
            </p>
